...
export default function SideNav({ isOpen, onClose }: any) {
  return (
    <>
      ...
      <div
        onClick={onClose}
        className={`fixed  z-40 transition-all duration-300 ${isOpen ? "opacity-100 visible" : "opacity-0 invisible"
          }`}
      ></div>
      ...
      <section
        ...
        z-50 p-10 transition-all duration-500 ${isOpen ? "translate-x-0" : "translate-x-full"
          }`}
      >
